...
const ARViewer = ({ visible, onClose, modelPath, productConfig }) => {
  ...
  useEffect(() => {
    if (visible) {
      ...
      params.append("model", modelPath);
      params.append("color", productConfig.color || "");
      params.append("texture", productConfig.texture || "");
      params.append("size", productConfig.size || "medium");
      params.append("handleType", productConfig.handleType || "bar");
      params.append("handleColor", productConfig.handleColor || "silver");
      params.append("legType", productConfig.legType || "C");
      params.append("legColor", productConfig.legColor || "#000000");
