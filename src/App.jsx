...
function TexturedCabinet({ config, showDimensions, mainRef, handleRef, legRef }) {
  ...
  useEffect(() => {
    ...
    if (legRef.current && legScene) {
      ...
      while (legRef.current.children.length > 0) {
        legRef.current.remove(mainRef.current.children[0]);
      }
      legRef.current.add(legClone);
    }
  }, [cabinetScene, handleScene, legScene, bodyMaterial, handleMaterial, legMaterial, mainRef, handleRef, legRef]);
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th style={{ padding: '4px', textAlign: 'right' }}>Value (m)</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td style={{ padding: '4px', textAlign: 'left' }}>Width</td>
                    <td style={{ padding: '4px', textAlign: 'right' }}>{dimensions.width.toFixed(2)}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: '4px', textAlign: 'left' }}>Height</td>
                    <td style={{ padding: '4px', textAlign: 'right' }}>{dimensions.height.toFixed(2)}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: '4px', textAlign: 'left' }}>Depth</td>
                    <td style={{ padding: '4px', textAlign: 'right' }}>{dimensions.depth.toFixed(2)}</td>
                  </tr>
                </tbody>
              </table>
            </div>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="md:hidden flex items-center justify-between p-4 bg-gray-100 border-b">
        <h1 className="text-xl font-normal">Cabinet Configurator</h1>
      ...
      <div className="flex flex-1 flex-col md:flex-row">
        {/* Sidebar (Hidden on mobile, toggled by hamburger menu) */}
        <div className={`fixed md:static inset-y-0 left-0 w-16 md:w-16 bg-white border-r z-50 transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 transition-transform duration-300 ease-in-out`}>
          <div className="flex flex-col items-center pt-4 gap-4">
            <button 
              className={`p-2 border rounded ${viewMode === 'default' ? 'bg-gray-200' : ''}`}
              onClick={() => { handleViewChange('default'); setIsSidebarOpen(false); }}
              title="Default View"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <rect x="3" y="3" width="18" height="18" rx="2" />
            ...
            <button 
              ...
              onClick={() => { downloadGLB(); setIsSidebarOpen(false); }}
              title="Download GLB"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
            ...
            <button 
              className={`p-2 border rounded ${viewMode === 'top' ? 'bg-gray-200' : ''}`}
              onClick={() => { handleViewChange('top'); setIsSidebarOpen(false); }}
              title="Top View"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M3 3h18v18H3z" />
            ...
            <button 
              className={`p-2 border rounded ${viewMode === 'front' ? 'bg-gray-200' : ''}`}
              onClick={() => { handleViewChange('front'); setIsSidebarOpen(false); }}
              title="Front View"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7" />
            ...
            <button 
              className={`p-2 border rounded ${viewMode === 'free' ? 'bg-gray-200' : ''}`}
              onClick={() => { handleViewChange('free'); setIsSidebarOpen(false); }}
              title="Free View"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M4 4h16v16H4z" />
            ...
            <button 
              className={`p-2 border rounded ${showDimensions ? 'bg-blue-200' : 'bg-gray-100'} hover:bg-blue-100`}
              onClick={() => { toggleDimensions(); setIsSidebarOpen(false); }}
              title="Show Dimensions"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M2 12h20M12 2v20M20 16v-4M4 8v8M16 4h4M4 20h4" />
            ...
            <button 
              className="p-2 border rounded bg-blue-50 hover:bg-blue-100"
              onClick={() => { openARViewerWithQR(); setIsSidebarOpen(false); }}
              title="View in AR with QR"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M21 4H3a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zM16 12 8 7v10l8-5z" />
            ...
            <button 
              className="p-2 border rounded bg-green-50 hover:bg-green-100"
              onClick={() => { openDirectARViewer(); setIsSidebarOpen(false); }}
              title="Direct AR View"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M12 2a10 10 0 0 0-10 10 10 10 0 0 0 10 10 10 10 0 0 0 10-10A10 10 0 0 0 12 2zm0 18a8 8 0 0 1-8-8 8 8 0 0 1 8-8 8 8 0 0 1 8 8 8 8 0 0 1-8 8zm-1-13h2v4h4v2h-4v4h-2v-4H7v-2h4z" />
            ...
            <button 
              className="p-2 border rounded bg-blue-50 hover:bg-blue-100"
              onClick={() => { takeScreenshot(); setIsSidebarOpen(false); }}
              title="Screenshot"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <rect x="3" y="3" width="18" height="18" rx="2" ry="2" />
        ...
        <div className="flex-1 flex flex-col">
          <div className="flex flex-col md:flex-row h-full">
            {/* Canvas */}
            <div className="w-full md:w-3/5 h-[50vh] md:h-screen bg-gray-50">
              <Canvas shadows dpr={[1, 2]} gl={{ preserveDrawingBuffer: true }} style={{ height: '100%', width: '100%' }}>
                <ambientLight intensity={0.5} />
                <spotLight position={[10, 10, 10]} angle={0.15} penumbra={1} intensity={1} />
                <pointLight position={[-10, -10, -10]} intensity={0.5} />
                <Suspense fallback={null}>
            ...
            {/* Configurator Panel */}
            <div className="w-full md:w-2/5 p-4 md:p-6 overflow-y-auto bg-white">
              <h1 className="text-2xl md:text-3xl font-normal mb-6 md:mb-8 hidden md:block">Cabinet Configurator</h1>
              <div className="space-y-4">
                <div className="config-select relative">
                  <div 
                    className="flex items-center justify-between bg-gray-100 p-3 rounded cursor-pointer"
                    onClick={toggleSizes}
                  >
                    ...
                    <div className="absolute z-10 w-full mt-1 bg-white border rounded shadow-lg">
                      {textures.map((texture) => (
                        <div 
                          ...
                          onClick={() => { updateConfig('texture', texture.id); setShowTextures(false); }}
                        >
                          {texture.id && <div className="w-6 h-6 mr-2 border rounded bg-gray-100 overflow-hidden"></div>}
                          <span>{texture.name}</span>
                        </div>
                      ))}
                    </div>
                ...
                <div className="config-select relative">
                  <div 
                    ...
                    onClick={toggleHandleTypes}
                  >
                    <span>Handle Type: {handleTypes.find(type => type.id === config.handleType)?.name || 'None'}</span>
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d={showHandleTypes ? "M18 15l-6-6-6 6" : "M6 9l6 6 6-6"} />
                    </svg>
                  </div>
                  ...
                  {showHandleColors && (
                    <div className="absolute z-10 w-full mt-1 bg-white border rounded shadow-lg">
                      {handleColors.map((color) => (
                        ...
                        >
                          <div className="flex items-center">
                            <div className="w-5 h-5 rounded mr-2" style={{ backgroundColor: color.color }}></div>
                            <span>{color.name}</span>
                          </div>
                        </div>
                      ))}
                ...
                <div className="config-select relative">
                  <div 
                    ...
                    onClick={toggleLegTypes}
                  >
                    <span>Leg Type: {legTypes.find(type => type.id === config.legType)?.name || 'None'}</span>
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d={showLegTypes ? "M18 15l-6-6-6 6" : "M6 9l6 6 6-6"} />
                    </svg>
                  </div>
                ...
                <div className="config-select relative">
                  ...
                  >
                    <div className="flex items-center">
                      <div 
                        className="w-5 h-5 rounded mr-2" 
                        style={{ backgroundColor: legColors.find(color => color.color === config.legColor)?.color || config.legColor }}
                      ></div>
                      <span>Leg Color: {legColors.find(color => color.color === config.legColor)?.name || 'Custom'}</span>
                    </div>
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-xs md:text-sm text-gray-400 ml-2 line-through">$ {originalPrice}</span>
                    </div>
                  </div>
                  <button className="bg-black text-white px-3 py-1 md:px-4 md:py-2 rounded hover:bg-gray-800 transition text-sm md:text-base">
                    Add to cart
                  </button>
                </div>
              </div>
          ...
          {showARViewer && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white p-4 rounded-lg w-[90vw] h-[90vh] max-w-4xl overflow-auto">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-semibold">View in AR</h3>
                  <button onClick={closeARViewer} className="text-gray-500 hover:text-gray-700">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                {arModelUrl ? (
                  <>
                    <button slot="ar-button" style={{ position: 'absolute', bottom: '20px', right: '20px', padding: '8px', background: '#000', color: '#fff', borderRadius: '4px', fontSize: '14px' }}>
                      Enter AR
                    </button>
                    <model-viewer
                      src={arModelUrl}
          ...
          {showScreenshotModal && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white p-4 rounded-lg w-[90%] max-w-2xl max-h-[90vh] overflow-auto">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-semibold">Your Cabinet Screenshot</h3>
                  <button onClick={closeScreenshotModal} className="text-gray-500 hover:text-gray-700">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <div className="mb-4">
                  {screenshotUrl && <img src={screenshotUrl} alt="Cabinet Configuration" className="w-full" />}
                </div>
                <div className="flex justify-end">
                  <button
                    onClick={downloadScreenshot}
                    className="bg-black text-white px-3 py-1 md:px-4 md:py-2 rounded hover:bg-gray-800 transition text-sm md:text-base"
                  >
                    Download
                  </button>
                </div>
